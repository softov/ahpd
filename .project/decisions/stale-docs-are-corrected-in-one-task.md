...
Correcting only the `--path` row was rejected: it is the row a user reads to learn what the daemon refuses, and it leaves five more that were verified in the same reading.
