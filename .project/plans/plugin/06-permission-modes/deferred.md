...
| The `@cofold/config` layered reader for the harness file | Still the plan 04 deferral; the mode and effort work did not touch the reader | [plugin/04 deferred](../04-agent-cofold-extras/deferred.md) |
