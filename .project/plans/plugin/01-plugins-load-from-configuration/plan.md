...
- **Done so far:** task 01, the contract and the fold, task 02, the resolver, and task 08, the registration checks, all done 2026-09-20.
- **Next action:** [task-03-load-and-apply.md](task-03-load-and-apply.md).
- **Open questions:**
