...
- The advertised record names a documentation page as an authorization server, and a person can only become a principal through `authenticate`, which the reference client cannot carry; plan [07 - Identity and the record](07-identity-and-the-record/plan.md).
