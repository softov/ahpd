...
| [03 - An agent backend over facio](plugin/03-agent-facio/plan.md) | high | planned 2026-09-20 | - | every model-backed provider, and the ACP plan after it |

Next free number in `plugin`: `04`.
